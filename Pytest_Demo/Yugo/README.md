...
postman
playground: https://gateway-uat3.project-g66.com/playground

## 如何创建用例

### 创建用例步骤
1、在conf文件夹下方中yaml文件编写相关的用例
2、添加graphql 语句
3、在testcase文件夹中编写测试脚本（读取相应的yaml和graphql）
2、当所有接口都编写好之后，可以直接运行run.py主程序，执行所有自动化接口
