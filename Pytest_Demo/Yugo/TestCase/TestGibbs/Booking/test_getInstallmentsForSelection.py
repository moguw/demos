...
@allure.step("test_getInstallmentsForSelection")
# @pytest.mark.run(order=3)
@graphql_control.get_graphql_query()
@pytest.mark.parametrize("Args",Yamls()["test_get_InstallmentsForSelection"])
def test_getInstallmentsForSelection(authToken,Args,query=None):
