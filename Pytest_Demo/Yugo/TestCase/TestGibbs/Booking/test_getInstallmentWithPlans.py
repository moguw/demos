...
@allure.step("getInstallmentWithPlans")
# @pytest.mark.run(order=3)
@graphql_control.get_graphql_query()
@pytest.mark.parametrize("Args",Yamls()["test_get_InstallmentWithPlans"])
def test_getInstallmentWithPlans(authToken,Args,query=None):
