...
@allure.step("test_updateAcademicYearBookingStatus")
# @pytest.mark.run(order=3)
@graphql_control.get_graphql_query()
@pytest.mark.parametrize("Args",Yamls()["test_Update_AcademicYearBookingStatus"])
def test_updateAcademicYearBookingStatus(authToken,Args,query=None):
