...
@allure.step("createContractTemplate")
# @pytest.mark.run(order=2)
@graphql_control.get_graphql_query()
@pytest.mark.parametrize("Args",Yamls()["test_createContractTemplate"])
def test_createContractTemplate(authToken,Args,query=None):
