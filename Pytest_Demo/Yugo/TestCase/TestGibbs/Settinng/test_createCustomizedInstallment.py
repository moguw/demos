...
@allure.step("test_createCustomizedInstallment")
# @pytest.mark.run(order=3)
@graphql_control.get_graphql_query()
@pytest.mark.parametrize("Args",Yamls()["test_create_CustomizedInstallment"])
def test_createCustomizedInstallment(authToken,Args,query=None):
